...
<head>
    ...
    <title>BSS Connect - Pengumuman</title>
        ...
        <div class="px-4 lg:px-10 -mt-20 relative z-10">
            ...
            <div class="bg-white mobile-card card-shadow p-6 lg:p-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="{{ route('lo.pengumuman.create') }}"
                ...
                <div class="space-y-5">
                    ...
                    <div class="task-card border border-gray-100 rounded-3xl p-5 bg-white">
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                            ...
                            <div class="flex gap-3">
                                ...
                                <a href="{{ route('lo.pengumuman.edit',$item->id) }}"
                                ...
                                <form action="{{ route('lo.pengumuman.destroy',$item->id) }}"
                                      method="POST">
                                    ...
                                    <button
                                        class="w-11 h-11 bg-red-50 hover:bg-red-100 rounded-2xl transition">
                    ...
                    <div class="text-center py-16">
                        ...
                        <p class="text-gray-500 text-sm mt-2">
                            Tambahkan pengumuman atau tugas baru untuk LO
                        </p>
