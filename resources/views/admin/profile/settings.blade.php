{{-- resources/views/admin/profile/settings.blade.php --}}
...
<head>
    ...
    <title>BSS Connect - Pengaturan Admin</title>
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm opacity-80">
                                    Atur preferensi akun dan tampilan admin panel
                                </p>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-slate-300 mt-1">
                                        Aktifkan pemberitahuan email admin
                                    </p>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-slate-300 mt-1">
                                        Aktifkan keamanan tambahan admin
                                    </p>
