...
<body class="bg-slate-50 antialiased">
    ...
    <div class="flex-1 space-y-8">
        <div>
            ...
            <nav class="space-y-1">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-4 bg-gradient-to-r from-blue-600/20 to-transparent text-blue-400 p-4 rounded-2xl border-l-4 border-blue-500 shadow-sm transition-all group">
    ...
    <div class="pt-6 mt-6 border-t border-slate-800/80">
        ...
        <main class="flex-1 flex flex-col h-screen overflow-hidden">
            ...
            <div class="px-6 lg:px-12 -mt-20">
                <div class="glass-card rounded-custom p-8 lg:p-10 shadow-xl border border-white max-w-7xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <a href="{{ route('admin.mahasiswa.index') }}" class="bg-indigo-50 p-6 rounded-[2rem] border border-indigo-100 transition-all hover:shadow-lg hover:-translate-y-1 block">
                        ...
                        <a href="{{ route('admin.lo.index') }}" class="bg-emerald-50 p-6 rounded-[2rem] border border-emerald-100 transition-all hover:shadow-lg hover:-translate-y-1 block">
            ...
            <div class="lg:hidden fixed bottom-6 left-6 right-6 bg-bss-dark/95 backdrop-blur-lg rounded-3xl py-4 px-8 flex justify-between items-center shadow-2xl z-50">
                <a href="{{ route('admin.dashboard') }}" class="text-blue-400"><i class="fa-solid fa-house-chimney text-xl"></i></a>
                ...
                <a href="{{ route('admin.mahasiswa.index') }}" class="text-slate-500 hover:text-white"><i class="fa-solid fa-user text-xl"></i></a>
            </div>
        </main>
    </div>
