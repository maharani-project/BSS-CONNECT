...
<head>
    ...
    <title>BSS Connect - Edit Profil Mahasiswa</title>
                    ...
                    <div class="lg:col-span-1">
                        ...
                        <div class="profile-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-6">
                            ...
                            <div class="flex flex-col items-center text-center">
                                ...
                                <div class="w-32 h-32 rounded-full bg-gray-100 p-3 mb-5">
                                ...
                                <div class="mt-5 w-full">
                                    ...
                                    <button
                                        class="w-full bg-[#17337a] hover:bg-[#12285f] text-white py-3 rounded-2xl text-sm font-bold transition">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="profile-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                    Perbarui data profil dan informasi akun mahasiswa
                                </p>

                            </div>

                            <form action="{{ route('mahasiswa.profile.update') }}" method="POST" class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           value="Mahasiswa"
                                           readonly
                                           class="input-style mt-2 bg-gray-100 cursor-not-allowed">
