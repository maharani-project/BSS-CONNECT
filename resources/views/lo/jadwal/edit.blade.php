    ...
    <main class="flex-1 overflow-hidden">
        ...
        <div class="px-4 lg:px-10 -mt-20 relative z-10">
            ...
            <div class="bg-white mobile-card card-shadow max-w-6xl mx-auto p-6 lg:p-8">
                ...
                <form action="{{ route('lo.jadwal.update', $jadwal->id) }}" method="POST">
                    ...
                    <div class="mt-5">
                        ...
                        <textarea
                            name="deskripsi"
                            rows="3"
                            class="w-full bg-[#edf2ff] rounded-2xl p-4 outline-none focus:ring-2 focus:ring-blue-200">{{ $jadwal->deskripsi }}</textarea>
