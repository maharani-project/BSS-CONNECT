{{-- resources/views/mahasiswa/profile/index.blade.php --}}
...
<head>
    ...
    <title>BSS Connect - Profil Mahasiswa</title>
                    ...
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Pengaturan akun dan keamanan mahasiswa
                            </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                        ...
                        <a href="{{ route('mahasiswa.profile.edit') }}"
                           class="menu-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-5 block">
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                Ubah informasi profil mahasiswa
                            </p>

                        </a>

                        <!-- SECURITY -->
                        <a href="{{ route('mahasiswa.security') }}"
                           class="menu-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-5 block">
                        ...
                        <a href="{{ route('mahasiswa.settings') }}"
                           class="menu-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-5 block">
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                Atur preferensi sistem mahasiswa
                            </p>

                        </a>

                        <!-- ACTIVITY -->
                        <a href="{{ route('mahasiswa.activity') }}"
                           class="menu-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-5 block">
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                Riwayat aktivitas akun mahasiswa
                            </p>
