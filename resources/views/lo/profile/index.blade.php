{{-- resources/views/lo/profile/index.blade.php --}}
...
<head>
    ...
    <title>BSS Connect - Profil LO</title>
            ...
            <div class="bg-white mobile-card card-shadow p-6 lg:p-8 max-w-6xl mx-auto">
                ...
                <div class="mt-10">
                    ...
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Pengaturan akun dan keamanan profil
                            </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                        ...
                        <a href="{{ route('lo.profile.edit') }}"
                           class="menu-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-5 block">
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                Ubah informasi profil dan data akun
                            </p>

                        </a>

                        <!-- KEAMANAN -->
                        <a href="{{ route('lo.profile.security') }}"
                           class="menu-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-5 block">
                        ...
                        <!-- PENGATURAN -->
                        <a href="{{ route('lo.profile.settings') }}"
                           class="menu-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-5 block">
                        ...
                        <!-- RIWAYAT -->
                        <a href="{{ route('lo.profile.activity') }}"
                           class="menu-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-5 block">
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                Lihat riwayat aktivitas akun LO
                            </p>
