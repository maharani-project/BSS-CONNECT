...
<head>
    ...
    <title>BSS Connect - Jadwal Mahasiswa</title>
        ...
        <div class="px-4 lg:px-10 -mt-16 relative z-10 pb-10">
            ...
            <div class="bg-white mobile-card card-shadow p-6 lg:p-8">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">
                            Seluruh agenda dan kegiatan mahasiswa BSS Connect
                        </p>
                ...
                <div class="space-y-5">
                    ...
                    <div class="jadwal-card bg-[#f8fafc] border border-gray-100 rounded-3xl p-6">

                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">

                            <div class="flex items-start gap-5">

                                <div class="w-16 h-16 rounded-2xl bg-[#17337a] text-white flex items-center justify-center text-2xl shadow-lg">
                                    <i class="fa-solid fa-calendar-days"></i>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex flex-wrap items-center gap-3">
                                        ...
                                        <span class="bg-blue-100 text-blue-700 text-[11px] px-3 py-1 rounded-full font-bold uppercase">
                                            Event
                                        </span>
                    ...
                    <div class="bg-gray-50 border border-dashed border-gray-200 rounded-3xl p-12 text-center">
                        ...
                        <div class="w-20 h-20 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mx-auto text-3xl">
                        ...
                        <p class="text-gray-500 text-sm mt-2">
                            Jadwal kegiatan mahasiswa akan tampil di halaman ini.
                        </p>
