...
<head>
    ...
    <title>BSS Connect - Data Mahasiswa</title>
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div class="w-28 h-28 rounded-full bg-white/20 p-2">
                                ...
                                <div class="w-full h-full rounded-full bg-white flex items-center justify-center">
                                    <i class="fa-solid fa-users text-5xl text-[#17337a]"></i>
                                </div>
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm opacity-80">
                                    Monitoring dan manajemen data mahasiswa BSS Connect
                                </p>
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full">
                        ...
                        <tr class="text-left text-gray-500 text-sm border-b">
                            ...
                            <th class="pb-4 font-semibold">Nama Mahasiswa</th>
                            <th class="pb-4 font-semibold">Email</th>
                            <th class="pb-4 font-semibold">NIM</th>
                            <th class="pb-4 font-semibold">Jurusan</th>
                            ...
                            <tr class="table-card">
                                ...
                                <td class="py-5">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed={{ $mahasiswa->name }}"
                                ...
                                <td colspan="7" class="py-20 text-center">
                                    ...
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 mt-2">
                                            Tambahkan data mahasiswa untuk mulai monitoring
                                        </p>
