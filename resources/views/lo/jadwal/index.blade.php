...
<head>
    ...
    <title>BSS Connect - Kelola Jadwal</title>
        ...
        <div class="main-blue h-[260px] rounded-b-[35px] px-5 lg:px-10 pt-10">
            ...
            <div class="text-white">
                ...
                <p class="tracking-[3px] text-[11px] mt-2 opacity-70 uppercase">
                    Agenda dan kegiatan BSS Connect
                </p>
                ...
                <div class="flex items-center justify-between mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">
                            Semua agenda kegiatan terdaftar
                        </p>

                    </div>

                    <a href="{{ route('lo.jadwal.create') }}"
                ...
                <div class="space-y-5">
                    ...
                    <div class="jadwal-card flex gap-4 bg-white border border-gray-100 rounded-3xl p-5">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('lo.jadwal.edit', $jadwal->id) }}"
                               class="w-10 h-10 rounded-2xl bg-blue-50 hover:bg-blue-100 flex items-center justify-center transition">

                                <i class="fa-solid fa-pen text-blue-600 text-sm"></i>

                            </a>

                            <form action="{{ route('lo.jadwal.destroy', $jadwal->id) }}"
                                  method="POST"
                                ...
                                <button
                                    class="w-10 h-10 rounded-2xl bg-red-50 hover:bg-red-100 flex items-center justify-center transition">
                    ...
                    <div class="text-center py-14 text-gray-500">
                        ...
                        <p class="text-sm mt-1">
                            Tambahkan agenda pertama untuk memulai aktivitas
                        </p>
